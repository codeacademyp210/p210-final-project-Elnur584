...
namespace PatoFinalProject.Models
{
    public class MenuMainDesert
    {
        ...
        [Display(Name = "5) Food Name")]
        public string Food5Name { get; set; }
        [Display(Name = "5) Food Price")]
        public string Food5Price { get; set; }
        [Display(Name = "5) Food Content")]
        public string Food5Description { get; set; }
    }
}